...
describe('executeImageCompare', () => {
    ...
    it('should execute image comparison successfully with default options', async () => {
        ...
        expect(compareImagesPixelmatch.default).toHaveBeenCalledWith(Buffer.from('mock-image-data'), Buffer.from('mock-image-data'), {
            ignore: [],
    ...
    it('should compare from base64 when not saving actuals', async () => {
        ...
        expect(compareImagesPixelmatch.default).toHaveBeenCalledWith(expect.any(Buffer), Buffer.from(base64Image, 'base64'), expect.any(Object));
