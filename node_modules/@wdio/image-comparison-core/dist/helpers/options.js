...
export function prepareIgnoreOptions(imageCompareOptions) {
    const ignoreDefaults = ['alpha', 'antialiasing', 'colors', 'less', 'nothing'];
    return ignoreDefaults.filter((option) => Object.keys(imageCompareOptions).find((key) => key.toLowerCase().includes(option) && imageCompareOptions[key]));
}
